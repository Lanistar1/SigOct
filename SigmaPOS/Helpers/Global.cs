...
namespace SigmaPOS.Helpers
{
    public static class Global
    {
        ...
        public static string TerminalUrl => $"{BaseUrl}/api/v1/agent/terminals/businesses/:id/:terminalSerialNumber";
        public static string WalletUrl => $"{BaseUrl}/api/v1/agent/businesses/:id/my-wallet";
        public static string NotificationUrl => $"{BaseUrl}/api/v1/agent/businesses/:id/my-notifications?from_date=2022-05-01 &to_date=2022-10-30&is_read=FALSE";
        public static string ReadNotificationUrl => $"{BaseUrl}/api/v1/agent/businesses/:id/my-notifications/:id/read";
        public static string MetricUrl => $"{BaseUrl}/api/v1/agent/businesses/:id/transactions/metrics?from_date=2022-05-01 &to_date=2022-10-30&status=SUCCESSFUL&type=CREDIT";
